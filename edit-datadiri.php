...
<br>
<br>
<h3 class="mbr-section-title display-2" style="color:#000000" ><center>Perbarui Data Diri</center></h3>
...
<?php
  ...
  $id_user = $_SESSION['id'];
  $aa = mysqli_query($conn, "select * from user where id_user = '$id_user'");
  $bb = mysqli_fetch_object($aa);
?>
			    	<form accept-charset="UTF-8" class="form-horizontal" role="form" action="edit-datadiri-proses.php?id=<?php echo $bb->id_user; ?>" method="POST">
						<fieldset>
							<div class="form-group">
                                                                <span class="col-md-3">Nama Lengkap</span>
								<div class="col-md-9">
									<input class="form-control" placeholder="Nama Lengkap" name="nama_lengkap" type="text"  maxlength="32" value="<?php echo $bb->nama_lengkap; ?>" required>
								</div>
							</div>
							<div class="form-group">
                                                                <span class="col-md-3">Nomor HP</span>
								<div class="col-md-9">
									<input class="form-control" placeholder="Nomor HP" name="nomor_hp" type="text" maxlength="13" value="<?php echo $bb->nomor_hp; ?>" required>
								</div>
							</div>
							<div class="form-group">
                                                                <span class="col-md-3">Email</span>
								<div class="col-md-9">
									<input class="form-control" placeholder="Email" name="email" type="email" maxlength="32" value="<?php echo $bb->email; ?>" required>
								</div>
							</div>
							<div class="form-group">
                                                                <span class="col-md-3">Asal Sekolah</span>
								<div class="col-md-9">
									<input class="form-control" placeholder="Asal Sekolah" name="asal_sekolah" type="text" maxlength="32" value="<?php echo $bb->asal_sekolah; ?>" required>
								</div>
							</div>
                            <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input class="form-control" placeholder="ID Line" name="id_line" type="text" maxlength="32" value="<?php echo $bb->id_line; ?>" >
								</div>
							</div>
							<div class="form-group">
                                                                <span class="col-md-3">ID Instagram</span>
								<div class="col-md-9">
									<input class="form-control" placeholder="ID Instagram" name="id_instagram" type="text" maxlength="32" value="<?php echo $bb->id_instagram; ?>" >
								</div>
							</div>
                                                        
							<div align="center">
<br><br>
							     <input class="btn btn-lg btn-success" align="center" type="submit" value="Perbarui">
                                                        </div>
							<br>
						</fieldset>
			      	</form>
