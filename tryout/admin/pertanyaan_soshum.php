...
<?php
  $result = $connect->query('SELECT p.*,s.nomor_sesi FROM pertanyaan p, sesi s WHERE s.id_soal = 2 AND s.id_sesi = p.id_sesi');
?>
...
<script>
  ...
  $.getJSON('_comm/sesi.php', {'id_soal': 2}, function (data) {
