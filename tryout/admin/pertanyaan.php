      ...
      <div class="box">
        ...
        <div class="box-body table-responsive">
          <table class="table table-bordered" id="dataTable">
            ...
            <tbody>
            <?php 
              $result = $connect->query("SELECT p.*,s.nomor_sesi FROM pertanyaan p, sesi s WHERE s.id_soal = $id_soal AND s.id_sesi = p.id_sesi");
...
<script>
  ...
  $.getJSON('_comm/sesi.php', {'id_soal': <?php echo $id_soal; ?>}, function (data) {
